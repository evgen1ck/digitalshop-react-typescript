...
export const ApiAdminVariantUploadUrl = ApiUrl + "admin/variant/upload"
...
export const patchAxioserWithFormData = (url: string, body: {[key: string]: any} = {}, file?: File): Promise<any> => {
    const headers: { [key: string]: string } = { Authorization: `Bearer ${localStorage.getItem("token")}` }
    let data = new FormData();
