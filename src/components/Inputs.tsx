...
export function GetElementInput(field: IFields) {

    return (
        <input className="block w-full p-3 mb-1" id={field.id} type={field.type} placeholder={field.placeholder} />
    )
}

export function GetSelect(field: IFields) {

    return (
        <div className="relative">
            <select className="block w-full py-3 px-4 pr-8" id={field.id}>
